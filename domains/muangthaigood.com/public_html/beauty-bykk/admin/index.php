                ...
                <div class="da-container clearfix">
                    ...
                    <div id="da-sidebar">
                        ...
                        <div id="da-main-nav" class="btn-container">
                            <ul>
                                <li class="<?=PAGE_CONTROLLERS=='home'?'active':''?>"><a href="#"> <!-- Icon Container --> <span
                                            class="da-nav-icon"> <img src="../images/icon-home.png"
                                                                  width="32" height="32">
                                        </span> หน้าแรก
                                    </a>
                                    <ul>
                                        <li><a href="<?php echo ADDRESS_ADMIN_CONTROL ?>slides">ภาพสไลด์</a></li>
                                ...
                                <li class="<?=PAGE_CONTROLLERS=='all_product' || PAGE_CONTROLLERS=='category' || PAGE_CONTROLLERS=='product' ?'active':''?>"><a href="#"> <!-- Icon Container --> <span
                                    ...
                                    <ul>
                                        ...
                                        <li><a href="<?php echo ADDRESS_ADMIN_CONTROL ?>category">จัดการหมวดหมู่สินค้า</a></li>
                                        <li><a href="<?php echo ADDRESS_ADMIN_CONTROL ?>product">จัดการสินค้า</a></li>
                                    </ul></li>
                                <li class="<?=PAGE_CONTROLLERS=='ordered'?'active':''?>"><a href="#"> <!-- Icon Container --> <span
                                    ...
                                    <ul>
                                        <li class=""><a href="<?php echo ADDRESS_ADMIN_CONTROL ?>ordered">ข้อมูลการสั่งซื้อ</a></li>

                                    </ul></li>
                              <li class="<?=PAGE_CONTROLLERS=='payment_confirm'?'active':''?>"><a href="#"> <!-- Icon Container --> <span
                                            class="da-nav-icon"> <img src="../images/icon-payment2.png"
                                                                  width="32" height="32">
                                        </span> แจ้งขำระเงิน
                                    </a>
                                    <ul>
                                          <li class=""><a href="<?php echo ADDRESS_ADMIN_CONTROL ?>payment_confirm_detail&action=edit&id=1">รายละเอียด</a></li>
                                        <li class=""><a href="<?php echo ADDRESS_ADMIN_CONTROL ?>payment_confirm">ข้อมูลการแจ้งขำระเงิน</a></li>
                                ...
                                <li class=""><a href="#"> <!-- Icon Container --> <span
