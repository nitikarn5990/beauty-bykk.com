    ...
    while ($row = $db->FetchArray($query)) {
        ?>
                                <tr onmouseover="this.className = 'yellowThing';"
                                    ...
                                    <td width="5%" class="center"><?php echo $row['status'] == '' || $row['status'] == 'ยังไม่ได้อ่าน' ? '<img src=' . ADDRESS_ASSETS . 'email-new.png width="35" height="35">' : '<img src=' . ADDRESS_ASSETS . 'email-old.png width="35" height="35">'; ?></td>
                                    <td width="7%" class="center"><?php echo $row['status'] == '' || $row['status'] == 'ยังไม่ได้อ่าน'? 'ยังไม่ได้อ่าน' : 'อ่านแล้ว'; ?></td>
