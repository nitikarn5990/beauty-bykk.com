                                        ...
                                        <table id="da-ex-datatable-sort" class="da-table" sort="3" order="asc" width="1000">
                                            ...
                                            <tbody>
                                                ...
                                                while ($row = $db->FetchArray($query)) {
                                                    ...
                                                    ?>
                                                    <tr style="<?= $classRead ?>">
                                                        <td  class="center" width="5%" style="font-size: 12px;display: none;"><input type="checkbox" value="<?php echo $row['id'] ?>" id="chkboxID"></td>
                                                        ...
                                                        <td class="center" style="font-size: 12px;">
                                                            ...
                                                            <a href="#" style="display: none;" onclick="if (confirm('คุณต้องการลบข้อมูลนี้หรือใม่?') == true) {
