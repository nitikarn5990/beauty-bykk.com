...
--
-- Host: localhost
-- Generation Time: Nov 25, 2015 at 01:54 PM
...
(1, 'เกี่ยวกับเรา', '<p>เกี่ยวกับเรา</p>', '0000-00-00 00:00:00', '2015-04-17 13:35:44');
...
CREATE TABLE IF NOT EXISTS `ads` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `ads_name` varchar(250) COLLATE utf8_unicode_ci NOT NULL,
  `link_to` text COLLATE utf8_unicode_ci NOT NULL,
...
--
-- Table structure for table `ads_files`
--
...
CREATE TABLE IF NOT EXISTS `ads_files` (
  ...
  `alt_tag` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=21 ;

--
-- Dumping data for table `ads_files`
--

INSERT INTO `ads_files` (`id`, `ads_id`, `file_name`, `alt_tag`) VALUES
(1, 1, '20150410205634_test2.jpg', 'กหดกหด789789'),
(2, 2, '20150410210019_logo (1).png', '78798'),
(3, 3, '20150410210542_test2.jpg', 'ส้ม555'),
(4, 4, '20150410210608_test.jpg', 'asdasd'),
(5, 1, '20150410210941_test.jpg', ''),
(6, 5, '20150411123823_logo (1).png', 'asdasd'),
(7, 6, '20150411125432_logo.png', ''),
(8, 7, '20150411125538_logo.png', 'nano'),
(9, 1, '20150411212511_test2.jpg', 'าสา่ส'),
(10, 1, '20150411213314_Untitled.png', ''),
(11, 1, '20150411213623_test.jpg', ''),
(12, 1, '20150411213818_test2.jpg', 'ดดดดด'),
(13, 3, '20150411213921_test.jpg', 'ส้มหหๅๅ'),
(14, 3, '20150411214704_test2.jpg', 'ส้มหหๅๅหฟกฟหก'),
(15, 1, '20150416223205_p1.png', 'คอลลาเจน'),
(16, 3, '20150416223254_1.png', 'coffee nano'),
(17, 7, '20150416223448_1.png', 'go nano'),
(18, 3, '20150418224904_3x2.jpg', 'coffee nano'),
(19, 1, '20150418225221_4.jpg', 'คอลลาเจน'),
(20, 1, '20150506225429_goold2.jpg', 'ดีท๊อกซ์, detox, ล้างสารพิษ, ดูแลสุขภาพ, ผิวสวย, หุ่นดี, อร่อย, กินง่าย, อาหารเสริม, ดูแล, ผิวพรรณ');
...
INSERT INTO `bank` (`id`, `bank_id`, `bank_branch`, `bank_number`, `bank_name`, `status`, `created_at`, `updated_at`) VALUES
(1, 2, 'ช้างคลาน', '123-789-123-1', 'ธนาคารกรุงไทย', 'ใช้งาน', '2015-04-11 14:13:27', '2015-04-16 22:38:53'),
(2, 5, 'Big C', '789456465', 'ธนาคารกสิกรไทย', 'ใช้งาน', '2015-04-11 14:16:28', '2015-04-16 22:39:38');
...
INSERT INTO `bank_company` (`id`, `bank_name`, `status`) VALUES
(1, 'ธนาคารกรุงเทพ', 'ใช้งาน'),
(2, 'ธนาคารกรุงไทย', 'ใช้งาน'),
(3, 'ธนาคารกรุงศรี', 'ใช้งาน'),
(4, 'ธนาคารทหารไทย', 'ใช้งาน'),
(5, 'ธนาคารกสิกรไทย', 'ใช้งาน'),
(6, 'ธนาคารไทยพานิชย์', 'ใช้งาน'),
(7, 'ธนาคารยูโอบี', 'ใช้งาน'),
(8, 'ธนาคารออมสิน', 'ใช้งาน'),
(9, 'ธนาคารสแตนดาร์ดชาร์เตอร์', 'ใช้งาน'),
(10, 'ธนาคารซิตี้แบงค์', 'ใช้งาน'),
(11, 'ธนาคารธนชาต', 'ใช้งาน');
...
CREATE TABLE IF NOT EXISTS `best_offer` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `offer_title` text COLLATE utf8_unicode_ci NOT NULL,
  `offer_detail` text COLLATE utf8_unicode_ci NOT NULL,
  `created_at` datetime NOT NULL,
  `updated_at` datetime NOT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `best_offer` (`id`, `offer_title`, `offer_detail`, `created_at`, `updated_at`) VALUES
(1, 'Reviews', '<div id="pgc-255-0-0" class="panel-grid-cell">\r\n<div id="panel-255-0-0-0" class="so-panel widget widget_black-studio-tinymce panel-first-child">\r\n<div class="textwidget">\r\n<p>&nbsp;</p>\r\n</div>\r\n</div>\r\n<div id="panel-255-0-0-1" class="so-panel widget widget_black-studio-tinymce panel-last-child">\r\n<div class="textwidget">\r\n<p>&nbsp;</p>\r\n</div>\r\n</div>\r\n</div>\r\n<div id="pgc-255-0-1" class="panel-grid-cell">\r\n<div id="panel-255-0-1-0" class="so-panel widget widget_black-studio-tinymce panel-first-child">\r\n<div class="textwidget">\r\n<p>&nbsp;</p>\r\n</div>\r\n</div>\r\n</div>', '2015-04-22 00:00:00', '2015-07-02 11:48:46');
...
CREATE TABLE IF NOT EXISTS `blog` (
  ...
  `blog_name_ref` text COLLATE utf8_unicode_ci NOT NULL,
  `blog_cover` text COLLATE utf8_unicode_ci NOT NULL,
  `blog_short_detail` text COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `blog_category` (
  ...
  `category_name_ref` varchar(250) COLLATE utf8_unicode_ci NOT NULL,
  `status` enum('ใช้งาน','ปิดใช้งาน') COLLATE utf8_unicode_ci NOT NULL,
  `created_at` datetime NOT NULL,
  `updated_at` datetime NOT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `blog_category` (`id`, `category_name`, `category_name_ref`, `status`, `created_at`, `updated_at`) VALUES
(1, 'กาแฟ', 'กาแฟ', 'ใช้งาน', '2015-04-20 10:28:53', '2015-06-05 11:51:21'),
(8, 'คอลาเจน', 'คอลาเจน', 'ใช้งาน', '2015-06-29 11:44:09', '2015-06-29 11:44:09'),
(5, 'ดีท๊อกซ์', 'ดีท๊อกซ์', 'ใช้งาน', '2015-04-20 14:37:33', '2015-06-05 11:51:41');
...
CREATE TABLE IF NOT EXISTS `category` (
  ...
  `category_name_ref` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `category` (`id`, `category_name`, `category_name_ref`, `category_title`, `category_detail`, `status`, `meta_title`, `meta_keywords`, `meta_descriptions`, `created_at`, `updated_at`) VALUES
(1, 'Coffee ', 'coffee', 'Coffee ', '<h1 class="product_title entry-title">Coffee&nbsp;</h1>', 'ใช้งาน', 'กาแฟลดน้ำหนัก, กาแฟลดความอ้วน,เครื่องดื่มลดความอ้วน, เครื่องดื่มลดน้ำหนัก', 'กาแฟลดน้ำหนัก, กาแฟลดความอ้วน, กาแฟ ลด น้ํา หนัก ยี่ห้อ\r\n\r\nไหน ดี, กาแฟ ลด ความ อ้วน ที่ ดี ที่สุด, เครื่องดื่มลดความอ้วน, เครื่องดื่มลดน้ำหนัก, กาแฟลดอ้วน, \r\n\r\nกาแฟผิวขาว, เครื่องดื่มลดน้ําหนักแบบชง', 'Nano Beauty Drink จำหน่ายกาแฟควบคุมน้ำหนัก\r\n\r\nเพื่อผิวสวย หุ่นเป๊ะ ในหนึ่งเดียว', '2015-04-03 00:00:00', '2015-06-29 12:59:56'),
(9, 'Detox', 'detox', 'Detox', '<h1 class="product_title entry-title">Detox</h1>', 'ใช้งาน', '', '', '', '2015-04-16 22:03:20', '2015-06-29 13:00:10'),
(10, 'Collagen', 'collagen', 'Collagen', '<p>Collagen</p>', 'ใช้งาน', '', '', '', '2015-06-29 11:05:10', '2015-06-29 13:00:27');
...
INSERT INTO `contact` (`id`, `contact_title`, `contact_detail`, `meta_title`, `meta_keywords`, `meta_descriptions`, `created_at`, `updated_at`) VALUES
(1, 'Contact.', '<p>&nbsp;</p>\r\n<p><span style="font-size: small;">เชิญกรอกข้อมุลเพื่อให้ทางเราติดต่อกลับ</span></p>', '', '', '', '2015-04-28 00:00:00', '2015-04-17 13:31:17');
...
CREATE TABLE IF NOT EXISTS `contact_footer` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `txt_address` text COLLATE utf8_unicode_ci NOT NULL,
  `txt_tel` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `contact_footer` (`id`, `txt_address`, `txt_tel`, `txt_email`, `created_at`, `updated_at`) VALUES
(1, '<p><strong><span style="font-size: small;">Mailing address 3124</span></strong></p>\r\n<p><strong><span style="font-size: small;">Thomas Drive Lafayette,</span></strong></p>\r\n<p><strong><span style="font-size: small;">IN 47909</span></strong></p>\r\n<p><strong><span style="font-size: small;">Phone (765) 414-1338</span></strong></p>\r\n<p><strong><span style="font-size: small;">Email Us </span></strong></p>\r\n<p><strong><span style="font-size: small;">Connect with us on Facebook</span></strong></p>', '', '', '2015-04-02 00:00:00', '2015-04-08 19:43:28');
...
CREATE TABLE IF NOT EXISTS `customer` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `login_email` varchar(250) COLLATE utf8_unicode_ci NOT NULL,
  `login_password` varchar(250) COLLATE utf8_unicode_ci NOT NULL,
  `customer_name` varchar(250) COLLATE utf8_unicode_ci NOT NULL,
  `customer_lastname` varchar(250) COLLATE utf8_unicode_ci NOT NULL,
  `customer_address` text COLLATE utf8_unicode_ci NOT NULL,
  `customer_tel` varchar(20) COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `customer` (`id`, `login_email`, `login_password`, `customer_name`, `customer_lastname`, `customer_address`, `customer_tel`, `province_id`, `amphur_id`, `district_id`, `zipcode`, `status`, `created_at`, `updated_at`, `last_login`, `register_date`) VALUES
(37, 'nitikarnboom20300@gmail.com', 'XnCOFXzvzFGHXS/GZ5kVEZ9PAE2N+oCeqydK87yGuwo=', 'nitikarn ', 'sangsuk', '12/6', '0881545990', 2, 55, 281, '50005', 'ใช้งาน', '2015-04-26 12:18:44', '2015-04-26 12:22:22', '2015-04-26 12:22:10', '2015-04-26 12:18:44'),
(38, 'timothon7@gmail.com', 'qaEVnXWDXkXa1Vv4h4YzaFNvh9jbFNr6WMWa+rvOeJU=', 'มณฑล', 'อ้นวันนา', '150/51 หมู่ 2 บ้านศรีบัวเงิน ', '0877172071', 38, 568, 5130, '50000', 'ใช้งาน', '2015-04-26 19:43:53', '2015-04-26 19:43:53', '2015-04-26 19:44:14', '2015-04-26 19:43:53'),
(34, 'nitikarnboom2030@gmail.com', 'XnCOFXzvzFGHXS/GZ5kVEZ9PAE2N+oCeqydK87yGuwo=', 'นิติกาล', 'แสงสุข', '12/6 ', '0881545990หห', 38, 569, 5143, '50005', 'ใช้งาน', '2015-04-21 11:23:18', '2015-04-26 20:23:52', '2015-07-09 21:25:53', '2015-04-21 11:23:18');
...
CREATE TABLE IF NOT EXISTS `google_map` (
  `id` int(11) NOT NULL,
  `google_iframe` text COLLATE utf8_unicode_ci NOT NULL,
  `created_at` datetime NOT NULL,
  `updated_at` datetime NOT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `google_map` (`id`, `google_iframe`, `created_at`, `updated_at`) VALUES
(1, '<iframe src="https://www.google.com/maps/d/embed?mid=zDggcAHxiIYA.kVUPqDK5s7X0" width="640" height="480"></iframe>', '2015-04-26 20:00:53', '2015-04-26 20:00:53');
...
(1, '123', '<p><img class="alignnone wp-image-57 size-full" src="http://www.nanobeautydrink.com/wp-content/uploads/2015/04/NanoWhiteCoffee.jpg" alt="NanoWhiteCoffee" width="960" height="460" /></p>\r\n<p>กาแฟปรุงสำเร็จชนิดผงตรา นาโน ไวท์ คอฟฟี่ (Nano White Coffee) กาแฟคุณภาพดี ให้ทั้งรสชาติและความหอม ผสมสารสกัดที่มีคุณประโยชน์จากธรรมชาติ ที่คัดสรรเพื่อคุณภาพอย่างพิถีพิถัน ซึ่งจะทำงานร่วมกันอย่างมีประสิทธิภาพสูงสุด จึงช่วยยับยั้งการสะสมของไขมันใหม่ เสริมสร้างมวลกล้ามเนื้อให้กระชับไม่หย่อนยานด้วยคอลลาเจน&nbsp; นอกจากนี้ยังอุดมด้วยแร่ธาตุต่าง ๆ และวิตามิน B1 B2 B6 B12 เพื่อส่งเสริมให้รูปร่างกระชับและผิวพรรณสดใสในทุก ๆ แก้ว และทุกวันของคุณ สูตรปราศจากน้ำตาล</p>\r\n<p><img class="alignnone size-full wp-image-74" src="http://www.nanobeautydrink.com/wp-content/uploads/2015/04/03.jpg" alt="03" width="800" height="800" /></p>\r\n<p><img class="alignnone size-full wp-image-71" src="http://www.nanobeautydrink.com/wp-content/uploads/2015/04/01.jpg" alt="01" width="800" height="800" /></p>\r\n<p><img class="alignnone size-full wp-image-70" src="http://www.nanobeautydrink.com/wp-content/uploads/2015/04/05.jpg" alt="05" width="800" height="800" /></p>\r\n<p>NANO WHITE COFFEE ส่วนประกอบที่สำคัญ (18 g ต่อซอง)</p>\r\n<p>(1) กาแฟ &nbsp;3.5กรัม</p>\r\n<p>(2) ครีมเทียม 9.5 กรัม</p>\r\n<p>(3) ไฟเบอร์ &nbsp;1 กรัม</p>\r\n<p>(4) อินนูลิน &nbsp;1 กรัม</p>\r\n<p>(ุ5) แคลเซียม &nbsp;500&nbsp;มิลลิกรัม</p>\r\n<p>(6) สารสกัดจากถั่วขาว &nbsp;300 มิลลิกรัม</p>\r\n<p>(7) คอลลาเจนเปปไทด์ &nbsp;230 มิลลิกรัม</p>\r\n<p>(8) สารสกัดจากส้มแขก &nbsp;100 มิลลิกรัม</p>\r\n<p>(9) สารสกัดจากใบแปะก๊วย &nbsp;60 มิลลิกรัม</p>\r\n<p>(10) แอลคาร์นิทีน &nbsp;100 มิลลิกรัม</p>\r\n<p>(11) สารสกัดจากจมูกถั่วเหลือง &nbsp;50 มิลลิกรัม</p>\r\n<p>(12) ซอยเปปไทด์ &nbsp;50 มิลลิกรัม</p>\r\n<p>(13) แอลกลูต้าไธโอน &nbsp;50 มิลลิกรัม</p>\r\n<p>(14) ซูคราโรส 10 มิลลิกรัม</p>\r\n<p>(15) ซิตรัสไบโอฟลาวานอย &nbsp;25 มิลลิกรัม</p>\r\n<p>(16) วิตามิน B1 &nbsp;2 มิลลิกรัม</p>\r\n<p>(17)&nbsp;วิตามิน B2 &nbsp;2 มิลลิกรัม</p>\r\n<p>(18)&nbsp;วิตามิน B6 &nbsp;2 มิลลิกรัม</p>\r\n<p>(19)&nbsp;วิตามิน B12 &nbsp;2 มิลลิกรัม</p>\r\n<p><iframe src="https://www.youtube.com/embed/VxQbd54-Nvo" frameborder="0" width="800" height="450"></iframe></p>\r\n<p>&nbsp;</p>\r\n<p>&nbsp;</p>\r\n<p class="example1"><span style="font-size: x-large;"><strong><span style="color: #cea112;">Nono Cofee Gold</span></strong></span></p>\r\n<p><img class="alignnone size-full wp-image-62" src="http://www.nanobeautydrink.com/wp-content/uploads/2015/04/NanoGoffeeGold.jpg" alt="NanoGoffeeGold" width="960" height="460" /></p>\r\n<p>ช่วยบำรุงร่างกาย ช่วยให้ร่างกายอบอุ่น ซ่อมแซมความเสื่อมของร่างกาย และชลอความชรา</p>\r\n<p><strong>สารสกัดจากโสม&nbsp;</strong>ช่วยกระตุ้นการไหลเวียนของเลือด และปรับสภาพผิวพรรณให้เต่งตึง แลดูอ่อนกว่าวัย ช่วยทำให้ผิวพรรณนุ่วและชุ่วมชื้น ป้องกันการเกิดริ้วรอย และที่สำคัญ มีสารต้านอนุมูลอิสระ แลดูอ่อนกว่าวัย</p>\r\n<p><strong>โกจิเบอรรี่</strong>&nbsp;อุดมไปด้วยสารต้านอนุมูลอิสระ และ วิตามิน B6 แก้การเป็นเหน็บชาและตะคริวง่าย และยังมี วิตามิน B12 ช่วยในการเสริมสร้างระบบประสาทอีกด้วย</p>\r\n<p><img class="alignnone size-full wp-image-84" src="http://www.nanobeautydrink.com/wp-content/uploads/2015/04/d8687737cf48f84409d00b3c725959743d0600e.jpg" alt="d8687737cf48f84409d00b3c725959743d0600e" width="643" height="728" /></p>\r\n<p><strong>NANO COFFEE GOLD &nbsp;ส่วนประกอบที่สำคัญ (18 g ต่อซอง) &nbsp;</strong></p>\r\n<p>( 1)ครีมเทียม 11.97 g. 74.65%</p>\r\n<p>(2)กาแฟ 3.00 g. 20.00%</p>\r\n<p>(3)โสม 400.00 mg. 2.67%</p>\r\n<p>(4) โกจิ เบอร์รี่ 400.00 mg. 2.67%</p>\r\n<p>(5) วิตามิน บี6 &nbsp;3.00 mg. 0.020%</p>\r\n<p>(6) วิตามิน บี 12 &nbsp;0.004 mg. 0.00003%</p>', '', '', '', '2015-04-16 00:00:00', '2015-06-29 13:05:37');
...
CREATE TABLE IF NOT EXISTS `orders` (
  ...
  `status` enum('รอการชำระเงิน','ชำระเงินแล้ว') COLLATE utf8_unicode_ci NOT NULL,
  `created_at` datetime NOT NULL,
  `updated_at` datetime NOT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `orders_detail` (`id`, `orders_id`, `product_id`, `qty`, `cost`) VALUES
(8, 18, 17, 5, 250),
(7, 18, 16, 5, 215),
(6, 18, 13, 5, 690),
(9, 19, 13, 5, 690),
...
CREATE TABLE IF NOT EXISTS `payment_confirm` (
  ...
  `bank_id` int(11) NOT NULL,
  `image_receipt` varchar(250) COLLATE utf8_unicode_ci NOT NULL,
  `created_at` datetime NOT NULL,
  `updated_at` datetime NOT NULL,
  `status` enum('รอการชำระเงิน','ชำระเงินแล้ว') COLLATE utf8_unicode_ci NOT NULL DEFAULT 'รอการชำระเงิน',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=27 ;
...
CREATE TABLE IF NOT EXISTS `products` (
  ...
  `product_name_ref` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  ...
  `products_file_name_cover` varchar(200) COLLATE utf8_unicode_ci NOT NULL,
  `sort` int(5) NOT NULL,
  `status` enum('ใช้งาน','ปิดใช้งาน') COLLATE utf8_unicode_ci NOT NULL,
  `created_at` datetime NOT NULL,
  `updated_at` datetime NOT NULL,
...
INSERT INTO `products` (`id`, `category_id`, `product_name`, `product_name_ref`, `product_title`, `meta_title`, `meta_descriptions`, `meta_keywords`, `product_detail`, `product_cost`, `product_weight`, `products_file_name_cover`, `sort`, `status`, `created_at`, `updated_at`) VALUES
(4, 1, 'Nano Coffee Goal', 'nano-coffee-goal', '<p><span>ช่วยบำรุงร่างกาย ช่วยให้ร่างกายอบอุ่น ซ่อมแซมความเสื่อมของร่างกาย และชลอความชรา</span></p>', 'Nano Coffee Goal', 'Nano Coffee Goal', 'Nano Coffee Goal', '<p><span><img src="../files/gallery/detai_1.jpg" alt="" width="566" height="271" /></span></p>\r\n<p>&nbsp;</p>\r\n<p>ช่วยบำรุงร่างกาย ช่วยให้ร่างกายอบอุ่น ซ่อมแซมความเสื่อมของร่างกาย และชลอความชรา</p>\r\n<p><strong>สารสกัดจากโสม&nbsp;</strong>ช่วยกระตุ้นการไหลเวียนของเลือด และปรับสภาพผิวพรรณให้เต่งตึง แลดูอ่อนกว่าวัย ช่วยทำให้ผิวพรรณนุ่วและชุ่วมชื้น ป้องกันการเกิดริ้วรอย และที่สำคัญ มีสารต้านอนุมูลอิสระ แลดูอ่อนกว่าวัย</p>\r\n<p><strong>โกจิเบอรรี่</strong>&nbsp;อุดมไปด้วยสารต้านอนุมูลอิสระ และ วิตามิน B6 แก้การเป็นเหน็บชาและตะคริวง่าย และยังมี วิตามิน B12 ช่วยในการเสริมสร้างระบบประสาทอีกด้วย</p>\r\n<p><img src="../files/gallery/detai_2.jpg" alt="" width="574" height="650" /></p>\r\n<p><strong>NANO COFFEE GOLD &nbsp;ส่วนประกอบที่สำคัญ (18 g ต่อซอง) &nbsp;</strong></p>\r\n<p>( 1)ครีมเทียม 11.97 g. 74.65%</p>\r\n<p>(2)กาแฟ 3.00 g. 20.00%</p>\r\n<p>(3)โสม 400.00 mg. 2.67%</p>\r\n<p>(4) โกจิ เบอร์รี่ 400.00 mg. 2.67%</p>\r\n<p>(5) วิตามิน บี6 &nbsp;3.00 mg. 0.020%</p>\r\n<p>(6) วิตามิน บี 12 &nbsp;0.004 mg. 0.00003%</p>\r\n<p>&nbsp;</p>\r\n<p><img src="../files/gallery/detai_2.jpg" alt="" width="643" height="728" /></p>', 195, 201, '20150416221531_1.png', 0, 'ใช้งาน', '2015-04-07 19:31:28', '2015-04-26 14:55:20'),
(19, 10, 'Go Collagen', 'go-collagen', '<p>1 กล่องบรรจุ15 กรัม x10ซอง ราคากล่องละ 890 บาท</p>', '', '', '', '<p><img class=" size-full wp-image-279 alignleft" src="http://www.nanobeautydrink.com/wp-content/uploads/2015/07/103021.jpg" alt="103021" width="500" height="389" /></p>\r\n<p>&nbsp;โก คอลลาเจน</p>\r\n<p>ประโยชน์ของคอลลาเจน</p>\r\n<p>1.ช่วยบำรุงผิวพรรณให้ชุ่มชื่นอยู่เสมอ</p>\r\n<p>2.ช่วยให้ผิวยืดหยุ่น&nbsp; ลดรอยเหี่ยวย่น</p>\r\n<p>3.ช่วยให้ฝ้า&nbsp; กระ&nbsp; จุดด่างดำจางลง</p>\r\n<p>4.บำรุงสุขภาพผม&nbsp; เล็บ&nbsp; และสายตา</p>\r\n<p>5.เพิ่มความแข็งแรงให้เล็บที่ผิดปกติ</p>\r\n<p>6.อุดมไปด้วยโปรตีน</p>\r\n<p>7.ปกป้องรังสียูวีที่รบกวนผิวจากแสงแดด</p>\r\n<p>8.ช่วยบำรุงผิวพรรณที่แห้งกร้านและถูกทำลาย</p>\r\n<p>9.ช่วยให้ผิวพรรณกระชับ&nbsp; เปล่งปลั่ง&nbsp; เนียนนุ่ม ดูอ่อนกว่าวัย</p>\r\n<p>10.เสริมสารคอลลาเจนในบริเวณข้อต่อกระดูก</p>\r\n<p>11.ช่วยเพิ่มมวลกระดูก&nbsp; ป้องกันโรคกระดูกพรุน</p>\r\n<p>12.เพิ่มความหนาของเส้นผม&nbsp;&nbsp; ลดการหลุดร่วง&nbsp; และเพิ่มความแข็งแรงให้&nbsp;&nbsp; เส้นผม</p>\r\n<p>&nbsp;</p>\r\n<p>ส่วนประกอบสำคัญ</p>\r\n<p>Fish Hydrolyzed Collagen (คอลลาเจน) &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 10 g</p>\r\n<p>L-Glutathione&nbsp;&nbsp; (แอล-กลูต้าไธโอน) &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;0.250 g</p>\r\n<p>Ascorbis&nbsp; Acid&nbsp; (วิตามินซี) &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 0.06 g</p>\r\n<p>Dextrose&nbsp; Monohyrate&nbsp; (เดกโตส) &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 4.56 g</p>\r\n<p>Mixed&nbsp; Fruit&nbsp; Flavour&nbsp;&nbsp; (มิกซ์ฟรุ๊ต) &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 0.1 g</p>\r\n<p>Sucralose&nbsp; (ซูคราโลส) &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 0.03 g</p>\r\n<p>วิธีรัปทาน : เทผลิตภัณฑ์1ซอง (15กรัม)ลงในน้ำธรรมดา หรือน้ำเย็น1แก้ว250มล.คนจนกระทั่งละลายหมดแล้วดื่มวันละ1ซอง ก่อนนอน</p>\r\n<p>คำเตือน:เด็ก สตรีมีครรภ์และสตรีให้นมบุตรไม่ควรรัปทาน ควรรัปทานอาหารที่หลากหลายครบ5หมู่ ในสัดส่วนที่พอเหมาะสมเป็นประจำ</p>\r\n<p>เลขที่&nbsp; อย. 13-2-04352-1-0013</p>\r\n<p>1 กล่องบรรจุ 15 กรัม x10ซอง ราคากล่องละ 890 บาท</p>', 890, 0, '20150629115635_Go Collagen.png', 0, 'ใช้งาน', '2015-06-29 11:10:15', '2015-07-02 11:36:23'),
(14, 9, 'Go Detox', 'go-detox', '<p><span>ช่วยดีท๊อกซ์ลำไส้ &hellip;อร่อยดูแลผิวพรรณ</span></p>', '', '', '', '<p><img src="../files/gallery/sss.jpg" alt="" width="664" height="664" /></p>\r\n<p>1.ใยอาหารสูง ช่วยขับสารพิษในร่างกาย<br />2.ลดคลอเรสเตอรอล ไขมันส่วนเกิน<br />3.น้ำหนักลดลงอย่างเห็นได้ชัด<br />4.เอวคอด หุ่นสวย เพียว<br />5. ผิวพรรณขาว กระจ่างใส</p>\r\n<p>ทานเยอะ อึดอัด ขับของเสีย น้ำหนักเกิน สาวๆต้องจัดเลย นะจ๊ะ&nbsp;รับรองผล 100%</p>', 890, 100, '20150416230005_1.png', 0, 'ใช้งาน', '2015-04-16 22:58:02', '2015-04-26 14:55:02'),
(16, 1, 'Nano Coffee Plus', 'nano-coffee-plus', '<p><span>สูตรเข้มข้นเพิ่มปริมาณไฟเบอร์ 5000 มก.ทำให้อิ่มเร็ว ลดความอยากอาหาร ช่วยให้ระบบขับถ่ายและระบบการย่อยอาหารทำงานได้ดีขึ้น</span></p>', 'Nano Coffee Plus', 'Nano Coffee Plus', 'Nano Coffee Plus', '<h2>&nbsp;</h2>\r\n<p><img class="alignnone size-full wp-image-66" src="http://www.nanobeautydrink.com/wp-content/uploads/2015/04/NanoCoffeePlus.jpg" alt="NanoCoffeePlus" width="960" height="460" /></p>\r\n<p>กาแฟนาโน คอฟฟี่พลัส สูตรเข้มข้นเพิ่มปริมาณไฟเบอร์ 5000 มก.ทำให้อิ่มเร็ว ลดความอยากอาหาร ช่วยให้ระบบขับถ่ายและระบบการย่อยอาหารทำงานได้ดีขึ้นเหมาะสำหรับผู้ที่ต้องการลดน้ำหนักอย่างปลอดภัยโดยไม่โยโย่และช่วยให้ผิวพรรณสดใสด้วย</p>\r\n<p><strong>NUTRIOSE&nbsp;</strong>เป็นใยอาหารที่สกัดจากข้าวสาลีและข้าวโพดแคลเลอรราต่ำ ไม่มีน้ำตาล และการดัดแปลงพันธุกรรม อุดมไปด้วยกากใยอาหารและพรีไบโอติกส์ ช่วยระบบการย่อยอาหาร สามารถจัดการกับปัญหาน้ำหนักตัวที่เพิ่มขึ้นได้ดี และช่วยเพิ่มปริมาณในการขับถ่ายก๊าซออกซิเจนออกจากร่างกาย (ผายลม) ลดปริมาณการเป็นกรด-ด่าง ในอุจจาระ และยังอุดมไปด้วยไฟเบอร์ ช่วยในการย่อยอาหารสูงและจัดการกับน้ำหนักตัวได้ดี</p>\r\n<p><strong>แอล-คาเนทีน&nbsp;</strong>ช่วยลำเลียงโมเลกุลไขมันเล็กๆเช้าไปในระดับเซลล์ของเรา ทำให้ไขมันแปรเปลี่ยนเป็นพลังงาน ทำให้ช่วยในการไขมันที่สะสมอยู่ในร่างการได้ดีขึ้น</p>\r\n<p><strong>ไลเลี่ยม ฮัสค์&nbsp;</strong>สามารถดูดซับน้ำตาลและไขมัน ช่วยลดการดูดซึมของไขมันเข้าสู่ร่างกาย ช่วยทำให้ระบบการทำงานลองลำใส้ได้ดียิ่งขึ้น ลดอาการท้องผูก</p>\r\n<p><strong>สารสกัดจากผลส้มแขก&nbsp;</strong>คือกรดไฮดร็อกซีซิตริค (Hydroxy Citric Acid) หรือ สารเอชซีเอ(HCA) ช่วยทำให้ร่างการที่มีสารกูโคสมรามีมากเกินไปไม่เปลี่ยนไปเป็นไขมันสะสม และช่วยเร่งการสลายไขมันเปลี่ยนไปเป็นพลังงาน และช่วยลดการสะสมของไขมันด้วย</p>\r\n<p><img class="alignnone size-full wp-image-86" src="http://www.nanobeautydrink.com/wp-content/uploads/2015/04/76a2772a0e3020c4ec02d65e08eefe1cff49efd.jpg" alt="76a2772a0e3020c4ec02d65e08eefe1cff49efd" width="647" height="728" /></p>\r\n<p>ใน Nano Coffee Plus ส่วนประกอบที่สำคัญ (18 g.ต่อซอง )</p>\r\n<p>1. ครีมเทียม (non-dairy Creamer) &nbsp;9 กรัม</p>\r\n<p>2. กาแฟ (lnstant coffee) 3กรัม</p>\r\n<p>3. ไฟเบอร์ (Fiber)NUTRIOSE 5กรัม</p>\r\n<p>4. ไซเลี่ยม ฮัสค์ (Psyllium Husk) 350 มิลลิกรัม</p>\r\n<p>5. แอลคาร์นิทีน (L-carnitine) 200มิลลิกรัม</p>\r\n<p>6. สารสกัดจากส้มแขก (Garcinia Extract) 200 มิลลิกรัม</p>\r\n<p>7. สารสกัดจากถั่วขาว (white kidney bean extract) 200 มิลลิกรัม</p>\r\n<p>8. สารสกัดจากเปลือกสน(Pine bark extract) 30 มิลลิกรัม</p>\r\n<p>9. สารสกัดจากเมล็ดองุ่น (Grape seed Extract)</p>\r\n<p>10. ซูคราโลส (Sucralose) 9.5 มิลลิกรัม</p>\r\n<p>11. โครเมี่ยม พิโคลิเนต (Chromium Picolinate ) 0.5 มิลลิกรัม</p>\r\n<p><iframe src="https://www.youtube.com/embed/9Hwjhj42_Yg" frameborder="0" width="800" height="600"></iframe></p>\r\n<p>&nbsp;</p>', 215, 250, '20150416233603_1.png', 0, 'ใช้งาน', '2015-04-16 23:36:03', '2015-04-26 14:55:38'),
(17, 1, 'Nano White Coffee', 'nano-white-coffee', '<p><span>กาแฟคุณภาพดี ให้ทั้งรสชาติและความหอม ผสมสารสกัดที่มีคุณประโยชน์จากธรรมชาติ ที่คัดสรรเพื่อคุณภาพอย่างพิถีพิถัน</span></p>', 'Nano White Coffee', 'Nano White Coffee', 'Nano White Coffee', '<h2>Product Description</h2>\r\n<p><img class="alignnone size-full wp-image-57" src="http://www.nanobeautydrink.com/wp-content/uploads/2015/04/NanoWhiteCoffee.jpg" alt="NanoWhiteCoffee" width="960" height="460" /></p>\r\n<p>กาแฟคุณภาพดี ให้ทั้งรสชาติและความหอม ผสมสารสกัดที่มีคุณประโยชน์จากธรรมชาติ ที่คัดสรรเพื่อคุณภาพอย่างพิถีพิถัน ซึ่งจะทำงานร่วมกันอย่างมีประสิทธิภาพสูงสุด จึงช่วยยับยั้งการสะสมของไขมันใหม่ เสริมสร้างมวลกล้ามเนื้อให้กระชับไม่หย่อนยานด้วยคอลลาเจน&nbsp; นอกจากนี้ยังอุดมด้วยแร่ธาตุต่าง ๆ และวิตามิน B1 B2 B6 B12 เพื่อส่งเสริมให้รูปร่างกระชับและผิวพรรณสดใสในทุก ๆ แก้ว และทุกวันของคุณ สูตรปราศจากน้ำตาล</p>\r\n<p><img class="alignnone size-full wp-image-74" src="http://www.nanobeautydrink.com/wp-content/uploads/2015/04/03.jpg" alt="03" width="800" height="800" /><img class="alignnone size-full wp-image-71" src="http://www.nanobeautydrink.com/wp-content/uploads/2015/04/01.jpg" alt="01" width="800" height="800" /><img class="alignnone size-full wp-image-70" src="http://www.nanobeautydrink.com/wp-content/uploads/2015/04/05.jpg" alt="05" width="800" height="800" /></p>\r\n<p>&nbsp;</p>\r\n<p>NANO WHITE COFFEE ส่วนประกอบที่สำคัญ (18 g ต่อซอง)</p>\r\n<p>(1) กาแฟ &nbsp;3.5กรัม</p>\r\n<p>(2) ครีมเทียม 9.5 กรัม</p>\r\n<p>(3) ไฟเบอร์ &nbsp;1 กรัม</p>\r\n<p>(4) อินนูลิน &nbsp;1 กรัม</p>\r\n<p>(ุ5) แคลเซียม &nbsp;500&nbsp;มิลลิกรัม</p>\r\n<p>(6) สารสกัดจากถั่วขาว &nbsp;300 มิลลิกรัม</p>\r\n<p>(7) คอลลาเจนเปปไทด์ &nbsp;230 มิลลิกรัม</p>\r\n<p>(8) สารสกัดจากส้มแขก &nbsp;100 มิลลิกรัม</p>\r\n<p>(9) สารสกัดจากใบแปะก๊วย &nbsp;60 มิลลิกรัม</p>\r\n<p>(10) แอลคาร์นิทีน &nbsp;100 มิลลิกรัม</p>\r\n<p>(11) สารสกัดจากจมูกถั่วเหลือง &nbsp;50 มิลลิกรัม</p>\r\n<p>(12) ซอยเปปไทด์ &nbsp;50 มิลลิกรัม</p>\r\n<p>(13) แอลกลูต้าไธโอน &nbsp;50 มิลลิกรัม</p>\r\n<p>(14) ซูคราโรส 10 มิลลิกรัม</p>\r\n<p>(15) ซิตรัสไบโอฟลาวานอย &nbsp;25 มิลลิกรัม</p>\r\n<p>(16) วิตามิน B1 &nbsp;2 มิลลิกรัม</p>\r\n<p>(17)&nbsp;วิตามิน B2 &nbsp;2 มิลลิกรัม</p>\r\n<p>(18)&nbsp;วิตามิน B6 &nbsp;2 มิลลิกรัม</p>\r\n<p>(19)&nbsp;วิตามิน B12 &nbsp;2 มิลลิกรัม</p>\r\n<p><iframe src="https://www.youtube.com/embed/VxQbd54-Nvo" frameborder="0" width="800" height="450"></iframe></p>', 250, 100, '20150416233843_1.png', 0, 'ใช้งาน', '2015-04-16 23:38:43', '2015-04-26 14:55:43');

-- --------------------------------------------------------

--
-- Table structure for table `products_message`
--
...
--
-- Dumping data for table `products_message`
--

INSERT INTO `products_message` (`id`, `product_title`, `product_detail`, `meta_title`, `meta_keywords`, `meta_descriptions`, `created_at`, `updated_at`) VALUES
(1, 'All PRODUCT 111', '<p><span>WinWin offers stylish and high quality golf bags and head covers. Some of the best sellers are the Daruma series, the Manekineko Cat series, the Daikokuten Good Luck series, and the Aloha series.111</span></p>', '2111', '3111', '1111', '2015-04-06 00:00:00', '2015-04-08 18:18:20');
...
CREATE TABLE IF NOT EXISTS `product_files` (
  ...
  `alt_tag` varchar(200) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `product_files` (`id`, `product_id`, `file_name`, `alt_tag`) VALUES
(11, 2, '20150407191824_products.jpg', 'cvbcvb'),
(3, 3, '20150407172526_test.jpg', ''),
(5, 3, '20150407174437_regis.gif', ''),
(6, 3, '20150407174905_solo.jpg', 'ทอสอบ'),
(7, 3, '20150407174943_regis.gif', 'test'),
(8, 3, '20150407174943_flag_Thai.png', 'test2'),
(10, 1, '20150407191611_products.jpg', 'ทอสอบ'),
(27, 5, '20150410194658_test.jpg', 'dsad'),
(16, 10, '20150407225357_products.jpg', 'test'),
(17, 7, '20150407225544_products.jpg', 'sdfdsf'),
(18, 9, '20150407230023_products.jpg', '789'),
(31, 12, '20150411233026_test2.jpg', 'sadd'),
(25, 8, '20150408153925_productsdetail.jpg', 'ทอสอบ'),
(26, 11, '20150408181313_20457wisitp3.jpg', '111'),
(28, 5, '20150410194658_test2.jpg', 'asdasd'),
(38, 4, '20150416221531_detai_1.jpg', '20150416221531_detai_1.jpg'),
(37, 4, '20150416221531_1.png', '20150416221531_1.png'),
(41, 13, '20150416222143_p2.jpg', '20150416222143_p2.jpg'),
(40, 13, '20150416222143_p1.png', '20150416222143_p1.png'),
(39, 4, '20150416221531_detai_2.jpg', '20150416221531_detai_2.jpg'),
(42, 14, '20150416230005_1.png', '20150416230005_1.png'),
(43, 16, '20150416233603_1.png', 'nano-coffee-plus'),
(44, 17, '20150416233843_1.png', 'nano-white-coffee'),
(47, 19, '20150629115635_Go Collagen.png', '20150629115635_Go Collagen.png'),
(48, 19, '20150702100529_103021.jpg', '20150702100529_103021.jpg');
...
CREATE TABLE IF NOT EXISTS `shipping` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `shipping_rate_min` double NOT NULL,
  `shipping_rate_max` double NOT NULL,
...
INSERT INTO `shipping` (`id`, `shipping_rate_min`, `shipping_rate_max`, `shipping_cost`) VALUES
(185, 0, 200, 50),
(186, 201, 500, 100);
...
--
-- Table structure for table `shipping_total`
--

CREATE TABLE IF NOT EXISTS `shipping_total` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `shipping_cost_total` double NOT NULL DEFAULT '0',
  `shipping_type` enum('rate_custom','rate_total') COLLATE utf8_unicode_ci NOT NULL DEFAULT 'rate_total',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=3 ;

--
-- Dumping data for table `shipping_total`
--

INSERT INTO `shipping_total` (`id`, `shipping_cost_total`, `shipping_type`) VALUES
(1, 50, 'rate_custom');

-- --------------------------------------------------------

--
-- Table structure for table `shopping_guide`
--

CREATE TABLE IF NOT EXISTS `shopping_guide` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `guide_title` text COLLATE utf8_unicode_ci NOT NULL,
  `guide_detail` text COLLATE utf8_unicode_ci NOT NULL,
  `meta_title` text COLLATE utf8_unicode_ci NOT NULL,
  `meta_keywords` text COLLATE utf8_unicode_ci NOT NULL,
  `meta_descriptions` text COLLATE utf8_unicode_ci NOT NULL,
  `created_at` datetime NOT NULL,
...
--
-- Dumping data for table `shopping_guide`
--

INSERT INTO `shopping_guide` (`id`, `guide_title`, `guide_detail`, `meta_title`, `meta_keywords`, `meta_descriptions`, `created_at`, `updated_at`) VALUES
(1, 'วิธีการสั่งซื้อ', '<p>วิธีการสั่งซื้อค้า</p>', '', '', '', '2015-04-28 00:00:00', '2015-04-17 14:31:19');
...
(17, 'Detox by Nano', '', 0, 'ใช้งาน', '2015-06-29 10:43:39', '2015-06-29 10:43:39'),
(16, 'Nano White Coffee2', '', 2, 'ใช้งาน', '2015-06-29 10:42:57', '2015-06-29 10:42:57'),
(15, 'Nano White Coffee', '', 1, 'ใช้งาน', '2015-06-29 10:41:19', '2015-06-29 10:43:09');
...
(26, 11, '20150507091248-slide-03-jpg', 'ดีท๊อกซ์, detox, ล้างสารพิษ, ดูแลสุขภาพ, ผิวสวย, หุ่นดี, อร่อย, กินง่าย, อาหารเสริม, ดูแล, ผิวพรรณ'),
(25, 11, '20150506224914-slide-03-jpg', ''),
(24, 12, '20150418224430-slide-02-jpg', 'asdsa'),
(23, 12, '20150418223130-slide-02-jpg', 'asdsa'),
(22, 10, '20150418191045-slide-01-jpg', 'fhghfh'),
(21, 10, '20150418190737-slide-01-jpg', 'fhghfh'),
(20, 12, '20150416222952-us-960x460-jpg', 'asdsa'),
(19, 11, '20150416222922-ct-960x460-1-jpg', ''),
(18, 10, '20150416222834-nanobeautydrink-960x460-1-jpg', 'fhghfh'),
(27, 13, '20150629101921-geode-gruppebilde-2-mb-copy-jpg', ''),
(28, 13, '20150629102139-img-0390-1170x7801-1170x780-jpg', ''),
(29, 14, '20150629102230-img-0390-1170x7801-1170x780-jpg', ''),
(30, 15, '20150629104119-98120-jpg', ''),
(31, 16, '20150629104257-98119-jpg', ''),
(32, 17, '20150629104339-101864-jpg', ''),
(33, 18, '20150702095424-103021-jpg', '');
...
CREATE TABLE IF NOT EXISTS `tag` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `tag_title` varchar(200) COLLATE utf8_unicode_ci NOT NULL,
  `link_to` text COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `tag` (`id`, `tag_title`, `link_to`) VALUES
(63, 'ผิวขาวใส', 'product-13'),
(64, 'อาหาร', 'product-4'),
(65, 'ปลอดภัย', 'product-4'),
(66, 'วิตามินบี 12', 'product-13'),
(67, 'วิตามินบี 6', 'product-16'),
(68, 'หุ่นเป๊ะ', 'product-4'),
(69, 'เอนไซม์คิวเทน', 'category-9'),
(70, 'ช่วยระบายขับถ่าย', 'category-9'),
(71, 'กรดอัลฟาไลโปอิค', 'category-1'),
(72, 'ขาวกระจ่างใส', 'category-4'),
(73, 'ไร้ไขมัน', 'product-4'),
(74, 'เด็กเด้ง', 'product-17'),
(75, ' สารสกัดเมล็ดองุ่น', 'product-16'),
(76, 'ลดความอยากอาหาร', 'product-16'),
(77, 'เบต้าแคโรทีน', 'product-17'),
(78, 'แอลกลูตาไธโอน', 'product-4'),
(79, 'คอลลาเจน', 'product-13'),
(80, 'อาหารเสริม', 'category-4'),
(81, 'อาหารเสริม', 'category-4');
...
(1, 1, 'admin', 'XnCOFXzvzFGHXS/GZ5kVEZ9PAE2N+oCeqydK87yGuwo=', '', '', '', '', '', '', 0, 0, '', '0000-00-00 00:00:00', '2014-02-09 15:39:33', '2015-04-26 19:18:21');
